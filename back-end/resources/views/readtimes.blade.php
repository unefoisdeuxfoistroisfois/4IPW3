...
<head>
    <meta charset="UTF-8">
    <title>Articles par temps de lecture - Euronews</title>
...
<body>
    ...
    <main style="max-width: 900px; margin: 40px auto; padding: 0 20px;">
        <h1 style="font-family: 'Bodoni MT', serif; color: rgb(197, 197, 0);">
            Articles par temps de lecture
        </h1>

        <p style="color: #666; margin: 20px 0;">
            Sélectionnez un temps de lecture pour voir tous les articles correspondants :
        </p>

        <ul style="list-style: none; padding: 0;">
            @foreach($readtimes as $time)
                <li style="margin: 15px 0;">
                    <a href="{{ route('articles.by.readtime', $time) }}" 
                       style="display: inline-block; padding: 15px 25px; background: #f5f5f5; color: #333; text-decoration: none; border-radius: 8px; font-size: 1.1rem; transition: all 0.3s;">
                        ⏱️ {{ $time }} minutes de lecture
                    </a>
                </li>
            @endforeach
        </ul>
        ...
        <div style="margin-top: 30px;">
            <a href="{{ url('/') }}" style="color: rgb(197, 197, 0);">← Retour à l'accueil</a>
        </div>
    </main>
